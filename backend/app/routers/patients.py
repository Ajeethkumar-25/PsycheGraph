...
async def create_patient(
    ...
    current_user: models.User = Depends(dependencies.require_role([models.UserRole.RECEPTIONIST, models.UserRole.ADMIN])),
...
async def update_patient(
    ...
    current_user: models.User = Depends(dependencies.require_role([models.UserRole.RECEPTIONIST, models.UserRole.ADMIN, models.UserRole.SUPER_ADMIN])),
    db: AsyncSession = Depends(database.get_db)
):
    query = select(models.Patient).where(models.Patient.id == patient_id)
    if current_user.role != models.UserRole.SUPER_ADMIN:
